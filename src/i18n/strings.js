...
const en = {
  ...
  history: {
    ...
    received: 'Family got',
    status: 'Status',
    empty: 'No past transfers match your criteria.',
    note: 'Records are saved locally in your browser so you can track your transfers anytime.',
    logTransfer: 'Log New Remittance',
    howItWorks: 'How History Works',
    resetData: 'Reset Sample Data',
    exportCsv: 'Export CSV',
    searchPlaceholder: 'Search country, channel, or status...',
    ...
    sortOptions: {
      ...
      receivedDesc: 'Received LKR: High to Low',
      rateDesc: 'Rate: High to Low',
    },
    stats: {
      totalSent: 'Total Remitted',
      totalReceived: 'Total Received (LKR)',
      avgRate: 'Avg Rate Achieved',
      totalTransfers: 'Total Transfers',
    },
    guide: {
      title: 'How the Remittance History Page Works',
      subtitle: 'Track past transfers and empower your Remittance Coach with AI pattern insights.',
      step1Title: '1. Log Past Transfers',
      step1Desc: 'Keep a record of money sent home, including amount, provider channel, and exchange rate achieved.',
      step2Title: '2. Automated AI Pattern Analysis',
      step2Desc: 'The system computes your transfer interval, average conversion delay, and expected next transfer date.',
      step3Title: '3. Proactive Rate Alerts',
      step3Desc: 'When exchange rates peak close to your expected transfer date, your Coach alerts you on the Dashboard.',
      step4Title: '4. Channel Fee Tracking',
      step4Desc: 'Review historical provider choices to see which channels consistently deliver maximum LKR to your family.',
    },
    form: {
      addTitle: 'Log New Remittance',
      editTitle: 'Edit Remittance Record',
      dateLabel: 'Transfer Date',
      currencyLabel: 'Currency',
      countryLabel: 'Sender Country',
      channelLabel: 'Channel / Provider',
      amountLabel: 'Amount Sent',
      rateLabel: 'Exchange Rate (LKR per 1 unit)',
      receivedLabel: 'Family Receives (LKR)',
      statusLabel: 'Status',
      save: 'Save Record',
      cancel: 'Cancel',
      validationError: 'Please enter valid positive numbers for amount and exchange rate.',
    },
  },
